...
<head>
    ...
    <link rel="stylesheet" href="template/assets/vendor/fonts/flag-icon-css/flg-icon.min.css">
    <link rel="icon" href="{{ asset('template/assets/images/favicon.ico') }}" type="image/x-icon">
    <title>Service Barang - Aston Printer</title>
</head>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="index.html">Aston Printer</a>
                        ...
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                <div class="nav-user-info">
                                    <h5 class="mb-0 text-white nav-user-name">Rian Rag </h5>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            <li class="nav-item ">
                                <a class="nav-link {{ $title == 'home' ? 'active' : ''; }}" href="/home"><i class="fa fa-fw fa-tachometer-alt"></i>Dashboard <span class="badge badge-success">6</span></a>
                            </li>
                            <li class="nav-divider">
                                Menu
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ $title == 'pelanggan' ? 'active' : ''; }}" href="/pelanggan"><i class="fa fa-fw fa-users"></i>Pelanggan</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ $title == 'karyawan' ? 'active' : ''; }}" href="/karyawan"><i class="fas fa-fw fa-cogs"></i>Karyawan/Petugas</a>
                            </li>
                            <li class="nav-divider">
                                Fitur
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-6" aria-controls="submenu-6"><i class="fas fa-fw fa-archive"></i> Rekap Data </a>
                                <div id="submenu-6" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/blank-page.html">Data Pelanggan</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/blank-page-header.html">Data Karyawan</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                             Copyright © 2022. All rights reserved. Dashboard by <a href="https://colorlib.com/wp/">Rian Rag</a>.
                        </div>
